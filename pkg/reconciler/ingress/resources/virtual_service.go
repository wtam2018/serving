...
func MakeVirtualService(ci *v1alpha1.Ingress, gateways []string) *v1alpha3.VirtualService {
...
func makeVirtualServiceSpec(ci *v1alpha1.Ingress, gateways []string) *v1alpha3.VirtualServiceSpec {
